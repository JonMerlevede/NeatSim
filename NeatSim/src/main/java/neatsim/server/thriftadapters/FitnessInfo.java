package neatsim.server.thriftadapters;
...
public class FitnessInfo extends CFitnessInfo {
	...
	public FitnessInfo(final double fitness, final boolean stopConditionSatisfied) {
		this(fitness);
		this.stopConditionSatisfied = stopConditionSatisfied;
	}

	public FitnessInfo(final double fitness, final double alternativeFitness, final boolean stopConditionSatisfied) {
		this(fitness, alternativeFitness);
		this.stopConditionSatisfied = stopConditionSatisfied;
	}
	 ...
	 */
	public FitnessInfo(final double fitness, final double alternativeFitness) {
	...
	public FitnessInfo(final double fitness) {
		this(fitness, fitness);
	}
}
