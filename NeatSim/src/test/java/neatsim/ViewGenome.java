...
public class ViewGenome {
	...
	public void viewGenome() throws Exception {
		...
		final List<GendreauScenario> ss = GendreauScenario.load("mydata/", "test_req_rapide_001_240_24");
		...
		final GendreauSimulationTaskVisible task = new GendreauSimulationTaskVisible("test_req_rapide_001_240_24", nnh, 10, -1, SolutionType.MYOPIC);
