...
import neatsim.core.evaluators.gendreau.simulators.LoggingGendreauSimulationTask;
...
//				if (no==8) newval=val;
		...
		final LoggingGendreauSimulationTask task = new LoggingGendreauSimulationTask(
