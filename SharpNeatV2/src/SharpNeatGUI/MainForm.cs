...
namespace SharpNeatGUI
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void txtFileBaseName_TextChanged(object sender, EventArgs e)
        {

        }

        private void chkFileSaveGenomeOnImprovement_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void txtPopulationStatus_TextChanged(object sender, EventArgs e)
        {

        }

        private void gbxCurrentStats_Enter(object sender, EventArgs e)
        {
