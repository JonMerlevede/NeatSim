...
namespace SharpNeat.Phenomes.NeuralNets
{
    ...
    public class FastCyclicNetwork : IBlackBox
    {
        ...
        public readonly IActivationFunction[] _neuronActivationFnArray;
        public readonly double[][] _neuronAuxArgsArray;

        // Neuron pre- and post-activation signal arrays.
        public readonly double[] _preActivationArray;
        public readonly double[] _postActivationArray;
        ...
        // Convenient counts.
        public readonly int _neuronCount;
        public readonly int _inputNeuronCount;
        public readonly int _outputNeuronCount;
        public readonly int _inputAndBiasNeuronCount;
        public readonly int _timestepsPerActivation;
